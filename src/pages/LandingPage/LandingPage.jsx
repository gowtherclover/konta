    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden">
          <div className="flex">
            <div className="flex-1 mx-auto max-w-7xl px-6 py-20 text-center">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-gray-900 animate-fadeUp">
              Organizá tus contactos en minutos
            </h1>

            <p className="mx-auto mt-5 max-w-2xl text-lg md:text-xl text-gray-600 animate-fadeUp delay-200">
              Contactario es el mini‑CRM que te ayuda a mantener tus contactos ordenados, accesibles y
              siempre actualizados con una interfaz intuitiva y herramientas potentes.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-4 animate-fadeUp delay-400">
              <Link
                to="/dashboard"
            ...
            <div className=" flex-1 mx-24 w-xl">
              <img
                src="/hero-konta-crm.jpg"
                alt="Vista del dashboard de Contactario"
                className="mx">
                </img> 
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 transform hover:scale-105 hover:shadow-lg transition-all duration-500">
                <h3 className="text-xl font-semibold text-gray-900">Importación masiva</h3>
                <p className="mt-2 text-gray-600">
                  Traé todos tus contactos desde archivos JSON en segundos y tenelos listos para organizar.
                </p>
              </div>

              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 transform hover:scale-105 hover:shadow-lg transition-all duration-500">
                <h3 className="text-xl font-semibold text-gray-900">Filtros potentes</h3>
                <p className="mt-2 text-gray-600">
                  Encontrá exactamente lo que necesitás con filtros avanzados y personalizables.
                </p>
              </div>

              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 transform hover:scale-105 hover:shadow-lg transition-all duration-500">
                <h3 className="text-xl font-semibold text-gray-900">Notas por cliente</h3>
                <p className="mt-2 text-gray-600">
                  Agregá notas detalladas a cada contacto para no olvidar ningún dato importante.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              />
              <TestimonialCard
                className="animate-fadeUp delay-600"
